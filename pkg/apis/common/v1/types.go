...
type JobStatus struct {
	...
	// StartTime => Frist in WaitingQueue timestamp
	// StartRunTime => First in RunningQueue timestamp
	// CompletionTime => First in FinishedQueue timestamp
	EnqueueTime  *metav1.Time `json:"enqueueTime,omitempty"`
