...
import (
	...
	"github.com/NTHU-LSALAB/DRAGON/pkg/apis/tensorflow/validation"
	...
	"github.com/NTHU-LSALAB/DRAGON/pkg/common/util/v1/unstructured"
...
func tfJobFromUnstructured(obj interface{}) (*tfv1.TFJob, error) {
	...
	// https://github.com/NTHU-LSALAB/DRAGON/issues/641
