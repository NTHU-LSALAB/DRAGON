...
import (
	...
	"github.com/NTHU-LSALAB/KubeShare/pkg/client/clientset/versioned/scheme"
	serializer "k8s.io/apimachinery/pkg/runtime/serializer"
	rest "k8s.io/client-go/rest"
)

type KubeshareV1Interface interface {
...
func (c *KubeshareV1Client) SharePods(namespace string) SharePodInterface {
	return newSharePods(c, namespace)
}

// NewForConfig creates a new KubeshareV1Client for the given config.
func NewForConfig(c *rest.Config) (*KubeshareV1Client, error) {
	...
	return &KubeshareV1Client{client}, nil
}

// NewForConfigOrDie creates a new KubeshareV1Client for the given config and
